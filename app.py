...
<style>
    ...
    /* BOTÃO LIMPAR SECUNDÁRIO (Ações) */
    /* Miramos especificamente no botão de Limpar por posição na coluna 3 */
    ...
    /* *************************************************** */
    /* FIX ESTILO BOTÃO CONVERSA (Passo 1) - DEVE SER IGUAL AO LIMPAR */
    /* *************************************************** */
...
with st.container(border=True):
    ...
    if script_final:
        ...
        with col_btn1:
            ...
            # Botão Conversa (Deve ser estilizado via CSS para o neon)
